...
*/
CREATE OR ALTER PROCEDURE oltp.sp_cadastrar_cliente
    @nome               VARCHAR(150),
    @email              VARCHAR(150),
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_cadastrar_endereco
    @cliente_id            BIGINT,
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_cadastrar_restaurante
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_cadastrar_categoria
    @nome           VARCHAR(100),
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_cadastrar_item_cardapio
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_criar_pedido
    @cliente_id            BIGINT,
    @restaurante_id        BIGINT,
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_adicionar_item_pedido
    @pedido_id          BIGINT,
...
BEGIN
    ...
    SELECT
        @restaurante_pedido_id = restaurante_id,
    ...
    SELECT
        @restaurante_item_id = restaurante_id,
        @nome_item = nome,
    ...
    BEGIN TRY
        ...
        UPDATE oltp.pedidos
        SET
            valor_subtotal = valor_subtotal + @valor_total_item,
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_atualizar_status_pedido
    @pedido_id          BIGINT,
...
*/
CREATE OR ALTER PROCEDURE oltp.sp_atualizar_status_pagamento
    @pedido_id          BIGINT,
...
SELECT * FROM oltp.usuarios;
SELECT * FROM oltp.clientes;
SELECT * FROM oltp.enderecos;
SELECT * FROM oltp.restaurantes;
SELECT * FROM oltp.categorias_cardapio;
SELECT * FROM oltp.itens_cardapio;
